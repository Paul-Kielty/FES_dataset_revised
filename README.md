...
#### More information and experimental results can be found in our paper: [Locally Adaptive Decay Surfaces for High-Speed Face and Landmark Detection with Event Cameras](https://arxiv.org/abs/2602.23101).
Citation:
``` 
